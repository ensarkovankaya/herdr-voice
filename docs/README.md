...
| [summarizer.md](summarizer.md)           | The `heuristic` / `llm` / `command` modes with copy-paste recipes (`claude -p`, OpenAI, Gemini).                           |
...
| [migration-v1-v2.md](migration-v1-v2.md) | What changed in v2 and why your old config keeps working.                                                                  |
